      ...
      <Popover open={open} onOpenChange={onOpenChange}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(filters.length > 0 && 'size-8', 'h-9')}
            ref={triggerRef}
  ...
  // eslint-disable-next-line no-lone-blocks
  {
    ...
    return (
      <div
        ...
        role='listitem'
        id={filterItemId}
        className='flex h-9 items-center rounded-md bg-background'
      ...
      >
        ...
        >
          <SelectTrigger
            ...
            className='h-9 rounded-none border-r-0 px-2.5 lowercase [&[data-size]]:h-9 [&_svg]:hidden'
          >
