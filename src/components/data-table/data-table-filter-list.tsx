    ...
    >
      ...
      <SortableOverlay>
        <div className='flex items-center gap-2'>
          <div className='h-9 min-w-[72px] rounded-none bg-primary/10' />
          <div className='h-9 w-32 rounded-none bg-primary/10' />
          <div className='h-9 w-32 rounded-none bg-primary/10' />
          <div className='h-9 min-w-36 flex-1 rounded-none bg-primary/10' />
      ...
      >
              ...
              ? (
                ...
                >
                  <SelectTrigger
                    ...
                    className=' lowercase [&[data-size]]:h-9'
                  >
        ...
        >
          <SelectTrigger
            ...
            className=' w-32  lowercase [&[data-size]]:h-9'
          >
  ...
  if (filter.operator === 'isEmpty' || filter.operator === 'isNotEmpty') {
    return (
      <div
        ...
        aria-live='polite'
        className='h-9 w-full  border bg-transparent dark:bg-input/30'
      />
    )
  }
      ...
      return (
        ...
        >
          <SelectTrigger
            ...
            className='h-9 w-full  [&[data-size]]:h-9'
          >
