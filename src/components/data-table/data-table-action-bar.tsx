      ...
      <AnimatePresence>
        {visible && (
          <motion.div
            ...
            className={cn(
              'fixed inset-x-0 bottom-6 z-50 mx-auto flex w-fit flex-wrap items-center justify-center gap-2 rounded-none border bg-background p-2 text-foreground shadow-sm',
              className
            )}
            {...props}
          >
...
function DataTableActionBarSelection<TData> ({
  ...
  return (
    <div className='flex h-7 items-center rounded-none border pr-1 pl-2.5'>
      ...
      <Tooltip>
        ...
        >
          ...
          <kbd className='select-none rounded border bg-background px-1.5 py-px font-mono font-normal text-[0.7rem] text-foreground shadow-xs'>
            <abbr title='Thoát' className='no-underline'>
              Esc
            </abbr>
          </kbd>
        </TooltipContent>
